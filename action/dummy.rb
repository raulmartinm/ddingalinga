...
#     ./katana service action --standalone --config action-dummy-service-ruby.yml --disable-compact-names --debug --timeout 100 --name dummy --parameter "id=Katana"
#  error:
...
def bootstrap(action)
  ...
  # action.set_entity({})
  action.set_entity({"id" => id.get_value()})
